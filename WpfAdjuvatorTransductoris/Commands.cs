...
namespace WpfAdjuvatorTransductoris
{
    internal class Commands
    {
        ...
        public static RoutedCommand LoadRecentProject { get; set; }
        ...
        public static RoutedCommand RenameNode { get; set; }
        ...
        static Commands()
        {
            ...
            LoadRecentProject = new RoutedCommand("LoadRecentProject", typeof(MainWindow));
            ...
            RenameNode = new RoutedCommand("RenameNode", typeof(MainWindow));
